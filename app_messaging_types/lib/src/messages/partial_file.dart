...
class PartialFileMessageType {
  ...
  factory PartialFileMessageType.fromJson(Map<String, dynamic> json) =>
      _$PartialFileMessageTypeFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$PartialFileMessageTypeToJson(this);
}
